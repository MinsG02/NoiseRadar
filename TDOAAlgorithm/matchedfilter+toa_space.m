...
disp('시뮬레이션 시작... (fs=192kHz, Noise=0.01, Matched Filter + Grid Search O)'); % (수정)
...
disp('계산 완료.');
%% --- 결과 출력 ---
disp('--- 4-Mic + 192kHz (Matched Filter + Grid Search, Noise=0.01) ---'); % (수정)
...
title('TDOA 위치 추정 (4-Mic, 192kHz, Matched Filter + Grid Search, Noise=0.01)'); % (수정)
hold off;